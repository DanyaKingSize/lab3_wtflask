...
def upload_file():
    ...
    if request.method == 'POST':
        if form.validate_on_submit():
            ...
            return render_template('form.html', form = form, img_1 = img_1, img_2 = img_2, compiled = final_image)
...
def graph_page():
    # Графики
    defs.GRAPHS(app.config['UPLOAD_FOLDER'] + 'to_be_joined_first.png', app.config['UPLOAD_FOLDER'] + 'to_be_joined_first_graph.png', 'Изображение 1')
    defs.GRAPHS(app.config['UPLOAD_FOLDER'] + 'to_be_joined_second.png', app.config['UPLOAD_FOLDER'] + 'to_be_joined_second_graph.png', 'ИЗображение 2')
    defs.GRAPHS(app.config['UPLOAD_FOLDER'] + 'timages_joined.png', app.config['UPLOAD_FOLDER'] + 'timages_joined_graph.png', 'Склейка')

    img_1 = app.config['UPLOAD_FOLDER'] + 'to_be_joined_first_graph.png'
    img_2 = app.config['UPLOAD_FOLDER'] + 'to_be_joined_second_graph.png'
    img_3 = app.config['UPLOAD_FOLDER'] + 'timages_joined_graph.png'
